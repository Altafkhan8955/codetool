...
urlpatterns = [
   ...
   path('protect_pdf/', views.ProtectPdf, name='protect_pdf'),
   path('unlook_pdf/', views.UnlockPdf, name='unlook_pdf'),
   path('pdf_split/', views.PdfSplitTool, name='pdf_split'),
   path('download_split_pdf/', views.DownloadSplitPdf, name='download_split_pdf'),
   path('compress_pdf/', views.CompressPdf, name='compress_pdf'),
   path('download_pdf/', views.DownloadPdf, name='download_pdf'),
   path('pdf_watermark_adder/', views.AddWatermark, name='pdf_watermark_adder'),
   path('download_watermark_pdf/', views.DownloadWatermarkedPdf, name='download_watermarked_pdf'),
   #########################Seo tool###########################################
